...
export const generatePerangkatPDF = async (groupedData, exportConfig) => {
    ...
    for (const [index, group] of groupedData.entries()) {
        ...
        // --- REVISI: Menghapus kolom FOTO DIRI dan FOTO KTP ---
        const head = [
            [
        ...
        // --- FITUR BARU: Menambahkan Tanda Tangan Kepala Desa dengan Tanggal Dinamis ---
    ...
    doc.save(`laporan_perangkat_desa.pdf`);
};
